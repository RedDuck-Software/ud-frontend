...
export interface DonateNFTInterface extends utils.Interface {
  functions: {
    "addValue(uint256,uint256)": FunctionFragment;
...
export interface DonateNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DonateNFTInterface;
